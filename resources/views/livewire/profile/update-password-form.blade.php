...
<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            Користете сигурна лозинка за поголема безбедност на профилот.
        </p>
    </header>

    <form wire:submit="updatePassword" class="mt-6 space-y-6">
        <div>
            <x-input-label for="update_password_current_password" :value="'Тековна лозинка'" />
        ...
        <div>
            <x-input-label for="update_password_password" :value="'Нова лозинка'" />
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="'Потврди лозинка'" />
